...
| [`data/display-quality-terms.csv`](data/display-quality-terms.csv) | 화질 용어 시멘틱 데이터 (**223개 용어**: 일반 55 + IDMS 130 + 컬러스케일 38) |
...
- 처리 완료: Ch01~06, Ch08~12, Ch17(3D), Ch20, Ch21 — 총 14개 챕터
- 미처리: Ch07(공간측정=해상도/MTF — 추천), Ch13(물리·기계)·14(전기)·15(프로젝터)·16(스크린)·19(근안)
