...
| [`data/display-quality-terms.csv`](data/display-quality-terms.csv) | 화질 용어 시멘틱 데이터 (**240개 용어**: 일반 55 + IDMS 147 + 컬러스케일 38) |
...
- 처리 완료: Ch01~12, Ch17(3D), Ch19(근안), Ch20, Ch21 — 총 16개 챕터
- 미처리: Ch13(물리·기계)·14(전기)·15(프로젝터)·16(스크린) — 화질 직결도 낮음
